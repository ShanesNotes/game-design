...
_Probed 2026-07-04T18:01:52.201Z by `scripts/verify-local-tools.mjs`; generated — do not hand-edit._
...
| builder | `claude --version` | yes | 2.1.201 (Claude Code) |
| builder | `codex --version` | yes | codex-cli 0.142.5 |
| builder | `omx --version` | yes | oh-my-codex v0.18.15 |
| builder | `grok-build --version` | no (PROBE) |  |
| harness | `playwright --version` | no (PROBE) |  |
